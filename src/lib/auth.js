...
export function isPasswordConfigured() {
    return Boolean(localStorage.getItem(STORAGE_KEYS.PASSWORD_HASH) ||
...
export function verifyPassword(inputPwd) {
...
export function changePassword(currentPwd, newPwd) {
...
export function getActiveSessionPassword() {
...
export function setActiveSessionPassword(pwd) {
