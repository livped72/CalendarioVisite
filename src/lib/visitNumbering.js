 ...
 */
export function normalizeCongName(name) {
    if (!name)
        return '';
 ...
 */
export function computeServiceYearVisitNumbers(anno, allSettimaneMap) {
...
export function predictVisitNumber(params) {
    const { anno, semestre, targetStartDate, targetCongregazioneNome, editingWeekId, forceReset, allSettimaneMap, } = params;
