...
export const WeekTable = ({ settimane, onEditWeek, onDeleteWeek, onDuplicateWeek, visitNumberMap, onViewAppuntamenti, }) => {
    ...
    return (_jsxs("div", { className: "bg-white rounded-2xl border border-[#E0DED9] shadow-2xs overflow-hidden", children: [_jsx("div", { className: "hidden lg:block overflow-x-auto", children: _jsxs("table", { className: "w-full text-left text-xs border-collapse", children: [_jsx("thead", { children: _jsxs("tr", { className: "border-b border-[#E0DED9] bg-[#FAF9F7] text-[#2F3332] font-bold uppercase tracking-wider text-[11px]", children: [_jsx("th", { className: "py-3 px-4 w-16 text-center", children: "#" }), _jsx("th", { className: "py-3 px-4 w-52", children: "Periodo (Mar \u2013 Dom)" }), _jsx("th", { className: "py-3 px-4 w-64", children: "Evento" }), _jsx("th", { className: "py-3 px-4", children: "Note" }), _jsx("th", { className: "py-3 px-3 w-16 text-right pr-4" })] }) }), _jsx("tbody", { className: "divide-y divide-[#EFECE6] text-[#2F3332]", children: displayItems.map((item) => {
                    ...
                    const visitNum = visitInfo?.numero;
                    const isCong = item.evento === 'congregazione';
                    return (_jsxs("div", { className: "p-3.5 hover:bg-[#FAF9F7] active:bg-[#FAF9F7] transition-colors flex items-center justify-between gap-3", children: [_jsxs("div", { className: "flex items-start gap-3 min-w-0 flex-1 cursor-pointer", onClick: () => onViewAppuntamenti ? onViewAppuntamenti(item.id) : onEditWeek(item), title: onViewAppuntamenti ? 'Vedi appuntamenti di questa settimana' : 'Modifica', children: [isCong && visitNum != null ? (_jsxs("div", { className: "flex flex-col items-center shrink-0 mt-0.5", children: [_jsx("span", { className: `w-6 h-6 rounded-full text-white text-[11px] font-bold flex items-center justify-center shadow-2xs ${getBadgeColor(visitNum)}`, children: visitNum }), visitInfo?.isReset && (_jsx("span", { className: "text-[8px] font-extrabold text-[#7C8B82] uppercase tracking-tighter mt-0.5", children: "Ciclo 1" }))] })) : (_jsx("span", { className: "w-6 h-6 rounded-full bg-[#F3F0EA] text-[#AAA] text-[10px] flex items-center justify-center shrink-0 mt-0.5", children: "\u2014" })), _jsxs("div", { className: "min-w-0 flex-1", children: [_jsxs("div", { className: "flex flex-wrap items-center gap-1.5 mb-1", children: [_jsx("span", { className: "font-bold text-xs text-[#2F3332]", children: abbreviateMonths(item.periodo) }), renderEventCell(item)] }), item.note && item.note !== '-' && (_jsx("div", { className: "text-xs text-[#666] truncate", children: item.note }))] })] }), _jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [onViewAppuntamenti && (_jsx("button", { onClick: () => onEditWeek(item), className: "p-1.5 rounded-lg text-[#AAA] hover:text-[#5B6760] hover:bg-[#FAF9F7] transition-colors cursor-pointer", title: "Modifica settimana", children: _jsx(Pencil, { className: "w-3.5 h-3.5" }) })), _jsx(ChevronRight, { className: "w-4 h-4 text-[#CCC] shrink-0" })] })] }, item.id));
